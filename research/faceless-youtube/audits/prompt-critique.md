...
7. **The same honest substance could ship as an English web property first.** Several sources point the same way:
   - `research/colony-sweep/audits/content-seo.md:195-199`: "An English-language property... the largest hole".
...
8. **The disclosure flag is inconsistent across siblings.** `production-stack.md:362` sets "AI use: Yes" for the
...
- Every MP / DISC / PAY line the scout cites was opened. The quotes match. The scout's code citations
  (`types.ts:213-215`, `rules.ts:62-81`) are exact.
