...
export const CANDIDATE_RAILS: CandidateRail[] = [
  ...
  },
  {
    ...
    beforeUse:
      "PAYABILITY RENDERED 7.9.2026 by .github/workflows/render-watch.yml (a GitHub runner has the egress this container lacks): Freemius's own docs page 'Supported Countries' lists ISRAEL under 'Supported Countries for Payouts' (research/rendered/freemius-supported-countries.txt line 308, between Isle of Man and Italy; the 'Unsupported Countries' list that follows holds Cuba, Iran and the other US-sanctioned states). The page also renders the payout methods verbatim: PayPal MassPay (default), Payoneer, wire (IBAN/SWIFT), Wise — 'countries where at least one payout method is available'. So PAYS ISRAEL = YES, rendered. STILL UNKNOWN: the payout CURRENCY (the earlier 'pays in ILS' claim was refuted from Freemius's code — ILS is buyer-side only; presume USD), the exact fee, hold and KYC (snippet-grade), and the prohibited-products list. Next render, already queued in research/rendered/urls.txt: /selling-with-freemius/your-earnings/ and /allowed-prohibited-products/. GITHUB CODE SEARCH was exhausted before the page was rendered (11 searches, 14 files). Until the earnings page is read, a line may plan on Freemius as a USD rail with an Israeli payout method, not as an ILS rail; railConcentration() stays 'concentrated' until a line actually rides it. Flagged, not resolved: under the EULA the seller's 'sole customer' is Freemius, Inc. (US), which cuts against zero-rating.",
    evidence: "rendered",
    source: "research/rendered/freemius-supported-countries.txt (rendered 7.9.2026); research/measurements/freemius-rail.md; research/colony-sweep/audits/productized-services.md §5.3",
  },
];
