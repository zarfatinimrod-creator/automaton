...
3. Publish: `apify push` with the API token; pay-per-event pricing ($1-5 per 1,000 results is the benchmark; rental pricing is retired); enable agentic buyers so agents can pay via x402/Skyfire.
