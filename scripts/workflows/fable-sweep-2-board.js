...
const board = await agent([
  ...
  'Read, in this order: ' + ROOT + '/MISSION.md in full (it binds you); ' + ROOT + '/research/colony-sweep/SWEEP-2.md lines 1-34 (the four shapes and why); ' + ROOT + '/research/colony-sweep/SCREEN-2.md (the summary, including the quote check and what the screening found about lines already committed); every .md report in ' + ROOT + '/research/colony-sweep/screen-2/ (one per candidate, with its verdict and decisive fact; results.json there is the same content as data, do not read it wholesale); then, per candidate, its section in SWEEP-2.md. Open research/rendered/*.txt, docs/REJECTED.md, research/colony-sweep/BOARD.md or source files only to check a specific point.',
  ...
  'Also rule on the "Found on the way" items in SCREEN-2.md, which concern lines already committed (oss-bounties, pcn874): say whether each changes a committed target now or waits for a named measurement (research/measurements/algora-terms-question.md; research/rendered/algora-terms.* once render-watch has fetched it).',
